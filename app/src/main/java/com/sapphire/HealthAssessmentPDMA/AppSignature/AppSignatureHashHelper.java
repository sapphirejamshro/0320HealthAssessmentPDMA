package com.sapphire.HealthAssessmentPDMA.AppSignature;
...
public class AppSignatureHashHelper extends ContextWrapper {
    ...
    public ArrayList<String> getAppSignatures() {
        ...
        try {
            ...
            for (Signature signature : signatures) {//NPznwWS2Cdy
//                String hash = hash(packageName, signature.toCharsString());
                String hash = hash(packageName, signature.toCharsString());
                if (hash != null) {
                    appSignaturesHashs.add(String.format("%s", hash));
                    //Toast.makeText(this,"hash key"+hash,Toast.LENGTH_SHORT).show();
       ...
       // System.out.println("--------==appSignaturesHashs "+appSignaturesHashs);
