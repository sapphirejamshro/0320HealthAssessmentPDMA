...
public class PublicSurveyFragment extends Fragment {
    ...
    private Boolean isForthQuesYesClick = false,isSpinnerCountryErrOccur = false,isFifthQuesYes=false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_public_survey, container, false);
        activity = getActivity();
        msgCounter = 0;
        countryString="";
        countryMap = new HashMap<String,String>();
        isBackButtonClicked = false;
        NavigationDrawerActivity.tvHeading.setText("SELF ASSESSMENT");
        init();
    ...
    private void buttonClickEvent() {
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* if (msgCounter == 2 && isForthQuesYesClick && isBackButtonClicked){
                    setCountryAdapter();
                }*/
                // for Question no 5
...
//                    addAssessmentData();
    ...
    private void init() {
        tvEngMsg = view.findViewById(R.id.tv_englishuMsg_PSF);
        tvQuestion = view.findViewById(R.id.tv_urduMsg_PSF);
        btnYes = view.findViewById(R.id.btn_yes_PSF);
        btnNo = view.findViewById(R.id.btn_no_PSF);
        linearLayoutAnswers = view.findViewById(R.id.linearLayoutAnswers);
        btnSubmit = view.findViewById(R.id.btnSubmitPSFrag);
        cardViewSubmitButton = view.findViewById(R.id.cardViewSubmitButtonPSFrag);
        cardViewYesButton = view.findViewById(R.id.cardViewYesButton_PSF);
        cardViewNoButton = view.findViewById(R.id.cardViewNoButton_PSF);
        cardViewBackButton = view.findViewById(R.id.cardViewBackButton_PSF);
        btnBack = view.findViewById(R.id.btn_back_PSF);
        ...
        mainScrollView = view.findViewById(R.id.scrollView_PSF);
        ...
        viewEmptyBack = view.findViewById(R.id.viewEmptyBack);
        tvQuestionNo = view.findViewById(R.id.tvQuestionNumber);
        edOtherDisease = view.findViewById(R.id.edOtherDiseasesPSF);
        cardViewOtherDiseasePSF = view.findViewById(R.id.cardViewOtherDiseasePSF);
        viewEmptySubmit = view.findViewById(R.id.viewEmptySubmit);
        tvOtherDiseaseError = view.findViewById(R.id.tvOtherDiseaseError);
...
//                            tvOtherDiseaseError.setVisibility(View.VISIBLE);
                    ...
                    if (optionListQuest8.size()>0){
                        ...
                        if ((cb.getText().toString().trim().equalsIgnoreCase("Other")
                            ...
                            //break;
                                ...
                                || cb.getText().toString().trim().equalsIgnoreCase("بيماري ڪونھي")) && cb.isChecked() ) {
                            isTrue = true;
                            if (selectedLanguage.equalsIgnoreCase("en")) {
                                ...
                                disableCheckBoxex(linearLayoutAnswers, "بيماري ڪونھي");
                            }
                    ...
                    public void onClick(View v) {
                        ...
                        if(cb.isChecked()){
                            ...
                            if(cb.getText().toString().trim().equalsIgnoreCase("Other") ||
                                    ...
                                    cb.getText().toString().trim().equalsIgnoreCase("کوئي بيماری نہیں")
                                    || cb.getText().toString().trim().equalsIgnoreCase("بيماري ڪونھي")
                            ){
    ...
    private void setBackButtonMargin(){
        ...
        params.topToBottom = R.id.cardViewSubmitButtonPSFrag;
    ...
    private void resSetBackButtonMargin(){
        ...
        params.setMargins(10, 30, 10, 0);
        params.topToBottom = R.id.cardViewNoButton_PSF;
        //params.bottomToBottom = R.id.innerView_PSF;
        cardViewBackButton.setLayoutParams(params);
    }
    private void setSubmitButtonMargin(){
        ...
        params.setMargins(10, 30, 10, 0);
        params.topToBottom = R.id.cardViewOtherDiseasePSF;
        //params.bottomToBottom = R.id.innerView_PSF;
...
//                        tvCountryError.setText("Country name does not exist.");
    ...
    private void addAssessmentData() {
        ...
        new SelfAssessmentQuestionService(activity).addAssessmentData(questionsResultHashMap, countryIdString, passportNoString,
                flightNoString,optionListQuest8,otherDiseaseName, nameString,mobileNoString,null,"Self",new VolleyCallback() {
                    @Override
                    public void onSuccess(JSONObject response) {
                        if(response!=null){
                            if(progressDialog.isShowing()){
                            ...
                            try {
                                if(!response.isNull("statusDescription") && !response.getString("statusDescription").equalsIgnoreCase("")){
                                    ...
                                    if(statusDescription.equalsIgnoreCase("Success")){
                                        Fragment assessmentFrag  = getActivity().getSupportFragmentManager().findFragmentByTag(PublicSurveyFragment.class.getSimpleName());
    ...
    private void addFocusChangeListener() {
        /*edFlightNo.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus || !edFlightNo.requestFocus()){
                    edFlightNo.clearFocus();
                }
                else{
                    hideCustomKeyboard();
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus || !edMobileNo.requestFocus()){
                   ...
                   //layoutParams.height = (edMobileNo.getHeight()/2);
                    layoutParams.height = (edMobileNo.getHeight()*3);
                    *//*mainScrollView.smoothScrollTo(0,spacingViewPersonInfoLayout.getBottom());
                    ConstraintLayout.LayoutParams layoutParams = (ConstraintLayout.LayoutParams) spacingViewPersonInfoLayout.getLayoutParams();
                    layoutParams.height = 400;*//*
                    spacingViewPersonInfoLayout.setLayoutParams(layoutParams);
...
/*                    edName.clearFocus();
        ...
        //for Disease name
       /* edOtherDisease.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
...
*/
    ...
    private void showKeyboard(View vLocal) {
        InputMethodManager inputMethodManager = (InputMethodManager) activity.getSystemService(Activity.INPUT_METHOD_SERVICE);
        if (inputMethodManager != null) {
            NavigationDrawerActivity.layoutBottomButtons.setVisibility(View.GONE);
            inputMethodManager.showSoftInputFromInputMethod(vLocal.getWindowToken(), 0);
            mainScrollView.smoothScrollTo(0,mainScrollView.getBottom());
...
/*    private void otherDiseaseNameEdittextListeners(final EditText editText){
        editText.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {

                commonEditText = editText;
                if (selectedLanguage.equalsIgnoreCase("Sindhi")){
               ...
               *//* if (editText.hasFocus()) {
                    View spacingView = view.findViewById(R.id.viewEmptySubmit);
                    ...
                    spacingView.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            mainScrollView.smoothScrollTo(0,mainScrollView.getBottom());
                            System.out.println("---@@## showKeyboard(),e dName has focus:  spacingViewHeight "+spacingViewPersonInfoLayout.getHeight());
                        }
                    }, 150);
                }*//*
                showCustomKeyboard(v);// Restore input type
